...
#define STEP_DIR0_Pin GPIO_PIN_1
#define STEP_DIR0_GPIO_Port GPIOC
...
#define CAM1_CTRL_GPIO_Port GPIOA
#define SERVO_PWM3_Pin GPIO_PIN_6
...
#define CAM0_CTRL_GPIO_Port GPIOC
#define SERVO_PWM1_Pin GPIO_PIN_0
#define SERVO_PWM1_GPIO_Port GPIOB
#define SERVO_PWM0_Pin GPIO_PIN_1
#define SERVO_PWM0_GPIO_Port GPIOB
