...
//    }
	...
	SERVO_CfgParam[au16_SERVO_Instance].Handle->Init.Prescaler = PSC_Value;
	SERVO_CfgParam[au16_SERVO_Instance].Handle->Init.CounterMode = TIM_COUNTERMODE_UP;
	SERVO_CfgParam[au16_SERVO_Instance].Handle->Init.Period = ARR_Value;
